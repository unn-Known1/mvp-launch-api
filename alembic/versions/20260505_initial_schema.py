...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "predictions", postgresql.JSON(astext_type=sa.Text()), nullable=False
        ),
        sa.Column(
            "model_metrics", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("status", sa.String(50), nullable=True),
        sa.Column("error_message", sa.Text(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "query_results", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column("confidence_score", sa.Integer(), nullable=True),
        sa.Column("confidence_level", sa.String(20), nullable=True),
        sa.Column(
            "follow_up_questions", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
    ...
    op.create_index(
        "ix_nl_query_history_created_at", "nl_query_history", ["created_at"]
    )
    ...
    op.create_index(
        "ix_anomaly_thresholds_dataset_id", "anomaly_thresholds", ["dataset_id"]
    )
    ...
    op.create_index(
        "ix_anomaly_notifications_user_id", "anomaly_notifications", ["user_id"]
    )
